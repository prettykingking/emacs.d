...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;; paren-face
   `(parenthesis ((,class :foreground "#8D8D84")))

   ;; display-fill-column-indicator-mode
   `(fill-column-indicator ((,class ,shadow)))

   ;; window-divider-mode
   `(vertical-border ((,class ,shadow)))
   `(window-divider ((,class :foreground "#9B9C97")))
   `(window-divider-first-pixel ((,class :foreground "#FFFFFF")))
   `(window-divider-last-pixel ((,class :foreground "#FFFFFF")))
   ...
   ;; Mode line faces.
   `(mode-line ((,class (:box (:line-width 1 :color "#335EA8") :foreground "#85CEEB" :background "#335EA8"))))
   `(mode-line-inactive ((,class (:box (:line-width 1 :color "#9B9C97") :foreground "#F0F0EF" :background "#9B9C97"))))
   ...
   `(header-line ((,class (:box (:line-width 1 :color "#F0F0F0") :foreground "black" :background "#F0F0F0"))))
   ...
   `(hl-line ((,class (:background "#EDF5FF")))) ; Highlight current line.
